    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__config__.offset !== undefined" label="表单偏移">
            <el-slider v-model="activeData.__config__.offset" :max="24" :min="0" :marks="{ 12: '' }" @change="offsetChange" />
          </el-form-item>
          ...
          <template v-if="['el-cascader', 'el-table'].includes(activeData.__config__.tag)">
            ...
            <!-- 级联选择静态树 -->
            <el-tree v-if="activeData.__config__.dataType === 'static'" draggable :data="activeData.options" node-key="id"
